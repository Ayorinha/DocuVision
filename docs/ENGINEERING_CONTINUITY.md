...
## Current mission
Document Intelligence layer: ingests and normalizes documents, extracts structure and text, and provides a foundation for OCR/document processing pipelines.
